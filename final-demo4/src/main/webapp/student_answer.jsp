...
<table border="1" cellspacing="0" width="80%">
    ...
    <c:forEach items="${student_answers}" var="student_answer" varStatus="status">
        <tr align="center">
            ...
            <td><a href="/final-demo4/student_answerCorrectServlet?id=${student_answer.id}">批改题目</a>
                <a href="/final-demo4/student_answerDeleteServlet?id=${student_answer.id}&course_name=${student_answer.course_name}">删除</a>
            </td>
        </tr>
    </c:forEach>
