...
@WebServlet("/discussionSelectAllByTeacherServlet")
public class DiscussionSelectAllByTeacherServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(Objects.equals(method, "manager")){
            request.getRequestDispatcher("/managerdiscussion.jsp").forward(request, response);
        }
        else {
