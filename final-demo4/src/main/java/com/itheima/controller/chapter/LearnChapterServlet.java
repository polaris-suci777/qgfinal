...
@WebServlet("/learnChapterServlet")
public class LearnChapterServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //3. 转发到course.jsp
        request.getRequestDispatcher("/learnchapter.jsp").forward(request,response);
    }
