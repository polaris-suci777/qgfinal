...
<table border="1" cellspacing="0" width="80%">
    ...
    <c:forEach items="${discussions}" var="discussion" varStatus="status">
        <tr align="center">
            ...
            <td><a href="/final-demo4/discussionSelectByIdServlet?id=${discussion.id}">回复学生评论</a>
                <a href="/final-demo4/discussionDeleteServlet?id=${discussion.id}">删除</a>
<%--                <a href="/final-demo4/chapterSelectAllServlet?&name=${discussion.name}">查看章节</a>--%>
            </td>
        </tr>
