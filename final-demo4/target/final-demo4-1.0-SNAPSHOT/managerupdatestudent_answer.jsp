...
<form action="/final-demo4/student_answerUpdateServlet" method="post">
    ...
    课程名称：<input name="course_name" value="${student_answer.course_name}"><br>
    题目内容：<input name="content" value="${student_answer.content}"><br>
    学生名字：<input name="student_name" value="${student_answer.student_name}"><br>
    学生答案：<input name="answer" value="${student_answer.answer}"><br>
    是否正确：<input name="is_correct" value="${student_answer.is_correct}"><br>
    题目得分：<input name="grade" value="${student_answer.grade}"><br>
