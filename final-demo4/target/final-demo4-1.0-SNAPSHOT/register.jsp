...
<div class="form-div">
    ...
    <form id="reg-form" action="/final-demo4/registerServlet" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="inputs">
                    ...
                    <img id="checkCodeImg" src="/final-demo4/checkCodeServlet">
...
<script>
    document.getElementById("changeImg").onclick = function () {
        document.getElementById("checkCodeImg").src = "/final-demo4/checkCodeServlet?"+new Date().getMilliseconds();
    }
